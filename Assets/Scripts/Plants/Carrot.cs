...
public class Carrot : PlantBaseClass
{
    ...
    protected override void Start()
    {
        ...
        {
            _plant_type = Utils.PlantType.Carrot;
    ...
    {
        if (_current_plant_stage == Utils.PlantStage.Ripe || !_active || !CheckGrowsInCurrentSeason())
        {
            return;
        }
    ...
    private bool CheckGrowsInCurrentSeason()
    {
        foreach (Utils.Season season in _growing_seasons)
        {
            if (season == TimeManager.Instance.GetCurrentSeason())
            {
                return true;
            }
        }
